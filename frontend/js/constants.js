const contractAddress = "0xB342C78DE97f9139b99F55d56DE78580351dE018"; //Replace with your own contract address
const chain = 'rinkeby'; // rinkeby or polygon

const welcome_h1 = "Welcome to the NFTitos Project!!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'The NFTitos Project is a tribute to Solution Street`s beloved intern, Tito Reynoso';
const h1_presale_coming_soon = "NFTitos Drop Coming Soon!!";
...
const button_presale_already_minted = "Join the NFTito Fan Club";
